# encoding: utf-8
# module unicodedata
# from /Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload/unicodedata.cpython-310-darwin.so
# by generator 1.147
"""
...
ucd_3_2_0 = None # (!) real value is '<unicodedata.UCD object at 0x105166380>'

_ucnhash_CAPI = None # (!) real value is '<capsule object "unicodedata._ucnhash_CAPI" at 0x1051989f0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x105198820>'

__spec__ = None # (!) real value is "ModuleSpec(name='unicodedata', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x105198820>, origin='/Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload/unicodedata.cpython-310-darwin.so')"
