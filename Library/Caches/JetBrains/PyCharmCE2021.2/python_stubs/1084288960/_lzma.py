# encoding: utf-8
# module _lzma
# from /Library/Developer/CommandLineTools/Library/Frameworks/Python3.framework/Versions/3.8/lib/python3.8/lib-dynload/_lzma.cpython-38-darwin.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x102d9eeb0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lzma', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x102d9eeb0>, origin='/Library/Developer/CommandLineTools/Library/Frameworks/Python3.framework/Versions/3.8/lib/python3.8/lib-dynload/_lzma.cpython-38-darwin.so')"
