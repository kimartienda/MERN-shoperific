...
expat_CAPI = None # (!) real value is '<capsule object "pyexpat.expat_CAPI" at 0x1059552d0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x105955400>'

__spec__ = None # (!) real value is "ModuleSpec(name='pyexpat', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x105955400>, origin='/Library/Developer/CommandLineTools/Library/Frameworks/Python3.framework/Versions/3.8/lib/python3.8/lib-dynload/pyexpat.cpython-38-darwin.so')"
