...
# from /Library/Developer/CommandLineTools/Library/Frameworks/Python3.framework/Versions/3.8/lib/python3.8/lib-dynload/_decimal.cpython-38-darwin.so
# by generator 1.147
...
class DecimalTuple(tuple):
    ...
    digits = None # (!) real value is '<_collections._tuplegetter object at 0x102d610d0>'
    exponent = None # (!) real value is '<_collections._tuplegetter object at 0x102d61190>'
    sign = None # (!) real value is '<_collections._tuplegetter object at 0x102d61100>'
    _fields = (
        'sign',
        'digits',
        'exponent',
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x102d00400>'

__spec__ = None # (!) real value is "ModuleSpec(name='_decimal', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x102d00400>, origin='/Library/Developer/CommandLineTools/Library/Frameworks/Python3.framework/Versions/3.8/lib/python3.8/lib-dynload/_decimal.cpython-38-darwin.so')"
