...
# from /Library/Developer/CommandLineTools/Library/Frameworks/Python3.framework/Versions/3.8/lib/python3.8/lib-dynload/_curses_panel.cpython-38-darwin.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x105b5e400>'

__spec__ = None # (!) real value is "ModuleSpec(name='_curses_panel', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x105b5e400>, origin='/Library/Developer/CommandLineTools/Library/Frameworks/Python3.framework/Versions/3.8/lib/python3.8/lib-dynload/_curses_panel.cpython-38-darwin.so')"
