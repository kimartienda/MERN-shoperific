# encoding: utf-8
# module _socket
# from /Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload/_socket.cpython-310-darwin.so
# by generator 1.147
"""
...
CAPI = None # (!) real value is '<capsule object "_socket.CAPI" at 0x104ee77e0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x104ee7850>'

__spec__ = None # (!) real value is "ModuleSpec(name='_socket', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x104ee7850>, origin='/Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload/_socket.cpython-310-darwin.so')"
