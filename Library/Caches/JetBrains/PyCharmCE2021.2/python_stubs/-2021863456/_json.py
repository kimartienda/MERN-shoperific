# encoding: utf-8
# module _json
# from /Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload/_json.cpython-310-darwin.so
# by generator 1.147
""" json speedups """
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x1050d0490>'

__spec__ = None # (!) real value is "ModuleSpec(name='_json', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x1050d0490>, origin='/Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload/_json.cpython-310-darwin.so')"
