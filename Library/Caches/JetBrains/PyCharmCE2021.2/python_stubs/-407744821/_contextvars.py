# encoding: utf-8
# module _contextvars
# from /Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload/_contextvars.cpython-310-darwin.so
# by generator 1.147
""" Context Variables """
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x101f98820>'

__spec__ = None # (!) real value is "ModuleSpec(name='_contextvars', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x101f98820>, origin='/Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload/_contextvars.cpython-310-darwin.so')"
