...
class _lru_cache_wrapper(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x14d816010>, '__call__': <slot wrapper '__call__' of 'functools._lru_cache_wrapper' objects>, '__get__': <slot wrapper '__get__' of 'functools._lru_cache_wrapper' objects>, 'cache_info': <method 'cache_info' of 'functools._lru_cache_wrapper' objects>, 'cache_clear': <method 'cache_clear' of 'functools._lru_cache_wrapper' objects>, '__reduce__': <method '__reduce__' of 'functools._lru_cache_wrapper' objects>, '__copy__': <method '__copy__' of 'functools._lru_cache_wrapper' objects>, '__deepcopy__': <method '__deepcopy__' of 'functools._lru_cache_wrapper' objects>, '__dict__': <attribute '__dict__' of 'functools._lru_cache_wrapper' objects>, '__doc__': 'Create a cached callable that wraps another function.\\n\\nuser_function:      the function being cached\\n\\nmaxsize:  0         for no caching\\n          None      for unlimited cache size\\n          n         for a bounded cache\\n\\ntyped:    False     cache f(3) and f(3.0) as identical calls\\n          True      cache f(3) and f(3.0) as distinct calls\\n\\ncache_info_type:    namedtuple class with the fields:\\n                        hits misses currsize maxsize\\n', '__module__': 'functools'})"
...
class __loader__(object):
    ...
    _ORIGIN = 'built-in'
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_frozen_importlib', '__doc__': 'Meta path import for built-in modules.\\n\\n    All methods are either class or static methods to avoid the need to\\n    instantiate the class.\\n\\n    ', '_ORIGIN': 'built-in', 'module_repr': <staticmethod(<function BuiltinImporter.module_repr at 0x1009f2320>)>, 'find_spec': <classmethod(<function BuiltinImporter.find_spec at 0x1009f23b0>)>, 'find_module': <classmethod(<function BuiltinImporter.find_module at 0x1009f2440>)>, 'create_module': <staticmethod(<function BuiltinImporter.create_module at 0x1009f24d0>)>, 'exec_module': <staticmethod(<function BuiltinImporter.exec_module at 0x1009f2560>)>, 'get_code': <classmethod(<function BuiltinImporter.get_code at 0x1009f2680>)>, 'get_source': <classmethod(<function BuiltinImporter.get_source at 0x1009f27a0>)>, 'is_package': <classmethod(<function BuiltinImporter.is_package at 0x1009f28c0>)>, 'load_module': <classmethod(<function _load_module_shim at 0x1009f17e0>)>, '__dict__': <attribute '__dict__' of 'BuiltinImporter' objects>, '__weakref__': <attribute '__weakref__' of 'BuiltinImporter' objects>})"
