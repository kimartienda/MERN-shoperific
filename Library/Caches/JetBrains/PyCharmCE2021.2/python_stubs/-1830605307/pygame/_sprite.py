...
# from /Users/kimartienda/Desktop/pythonProject1/pygame1/venv/lib/python3.10/site-packages/pygame/_sprite.cpython-310-darwin.so
# by generator 1.147
"""
...
import pygame as pygame # /Users/kimartienda/Desktop/pythonProject1/pygame1/venv/lib/python3.10/site-packages/pygame/__init__.py
...
class AbstractGroup(object):
    ...
    _spritegroup = True
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x10366bf60>'
...
class collide_circle_ratio(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pygame._sprite\', \'__doc__\': "detect collision between two sprites using scaled circles\\n\\n    This callable class checks for collisions between two sprites using a\\n    scaled version of a sprite\'s radius. It is created with a ratio as the\\n    argument to the constructor. The instance is then intended to be passed as\\n    a collided callback function to the *collide functions.\\n\\n    New in pygame 1.8.1\\n\\n    ", \'__init__\': <cyfunction collide_circle_ratio.__init__ at 0x10362d220>, \'__call__\': <cyfunction collide_circle_ratio.__call__ at 0x10362d2f0>, \'__dict__\': <attribute \'__dict__\' of \'collide_circle_ratio\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'collide_circle_ratio\' objects>})'
...
class collide_rect_ratio(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pygame._sprite\', \'__doc__\': "A callable class that checks for collisions using scaled rects\\n\\n    The class checks for collisions between two sprites using a scaled version\\n    of the sprites\' rects. Is created with a ratio; the instance is then\\n    intended to be passed as a collided callback function to the *collide\\n    functions.\\n\\n    New in pygame 1.8.1\\n\\n    ", \'__init__\': <cyfunction collide_rect_ratio.__init__ at 0x10362d080>, \'__call__\': <cyfunction collide_rect_ratio.__call__ at 0x10362d150>, \'__dict__\': <attribute \'__dict__\' of \'collide_rect_ratio\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'collide_rect_ratio\' objects>})'
...
class Sprite(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x1047a58f0>, '__repr__': <slot wrapper '__repr__' of 'pygame._sprite.Sprite' objects>, '__init__': <slot wrapper '__init__' of 'pygame._sprite.Sprite' objects>, 'add': <method 'add' of 'pygame._sprite.Sprite' objects>, 'remove': <method 'remove' of 'pygame._sprite.Sprite' objects>, 'add_internal': <method 'add_internal' of 'pygame._sprite.Sprite' objects>, 'remove_internal': <method 'remove_internal' of 'pygame._sprite.Sprite' objects>, 'update': <method 'update' of 'pygame._sprite.Sprite' objects>, 'kill': <method 'kill' of 'pygame._sprite.Sprite' objects>, 'groups': <method 'groups' of 'pygame._sprite.Sprite' objects>, 'alive': <method 'alive' of 'pygame._sprite.Sprite' objects>, '__dict__': <attribute '__dict__' of 'pygame._sprite.Sprite' objects>, '__g': <attribute '__g' of 'pygame._sprite.Sprite' objects>, 'image': <attribute 'image' of 'pygame._sprite.Sprite' objects>, 'rect': <attribute 'rect' of 'pygame._sprite.Sprite' objects>, '__doc__': 'simple base class for visible game objects\\n\\n    pygame.sprite.Sprite(*groups): return Sprite\\n\\n    The base class for visible game objects. Derived classes will want to\\n    override the Sprite.update() method and assign Sprite.image and Sprite.rect\\n    attributes.  The initializer can accept any number of Group instances that\\n    the Sprite will become a member of.\\n\\n    When subclassing the Sprite class, be sure to call the base initializer\\n    before adding the Sprite to Groups.\\n\\n    ', '__pyx_vtable__': <capsule object NULL at 0x10366bfc0>, '__reduce__': <method '__reduce_cython__' of 'pygame._sprite.Sprite' objects>, '__setstate__': <method '__setstate_cython__' of 'pygame._sprite.Sprite' objects>})"
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x10366bfc0>'
...
class RenderPlain(AbstractGroup):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x103668f00>'
...
class GroupSingle(AbstractGroup):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x103668d20>'
...
class LayeredUpdates(AbstractGroup):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x103668de0>'
...
class LayeredDirty(LayeredUpdates):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x103668d80>'
...
class RenderUpdates(Group):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x103668ea0>'
...
class OrderedUpdates(RenderUpdates):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x103668e40>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x10366beb0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pygame._sprite', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x10366beb0>, origin='/Users/kimartienda/Desktop/pythonProject1/pygame1/venv/lib/python3.10/site-packages/pygame/_sprite.cpython-310-darwin.so')"
