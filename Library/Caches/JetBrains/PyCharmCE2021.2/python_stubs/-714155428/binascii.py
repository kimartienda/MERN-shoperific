# encoding: utf-8
# module binascii
# from /Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload/binascii.cpython-310-darwin.so
# by generator 1.147
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x101190820>'

__spec__ = None # (!) real value is "ModuleSpec(name='binascii', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x101190820>, origin='/Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/lib-dynload/binascii.cpython-310-darwin.so')"
